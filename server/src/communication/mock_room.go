...
//
//	mockgen -source=room.go -package=communication -destination=mock_room.go
//
...
func (m *MockRoomStateHandler) HandleCache(cache *Duration, workerUUID uuid.UUID, username string) {
	m.ctrl.T.Helper()
...
func (m *MockRoomStateHandler) SetDuration(duration Duration) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetDuration", duration)
}

// SetDuration indicates an expected call of SetDuration.
func (mr *MockRoomStateHandlerMockRecorder) SetDuration(duration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetDuration", reflect.TypeOf((*MockRoomStateHandler)(nil).SetDuration), duration)
}
